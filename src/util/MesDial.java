...
public class MesDial {
    ...
    //
    private static String addressError = "Insert a correct Email Address...";
    private static String ipError = "The domain does not resolve to an IP address.";
    ...
    public static void ipError(GUI aFrame) {
        JOptionPane.showMessageDialog(aFrame, ipError, "Error!", JOptionPane.ERROR_MESSAGE);
    }
}
